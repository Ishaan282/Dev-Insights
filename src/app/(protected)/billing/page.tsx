...
const BillingPage = () => {
    ...
    const price = (creditstoBuyAmount / 1).toFixed(2)
    return (
        // <div>BillingPage</div>
        <div>
            ...
            <Slider defaultValue={[100]} max={5000} min={10} step={10} onValueChange={value => setCreditsToBuy(value)} value={creditsToBuy} />
            <div className="h-4"></div>
            <Button onClick={() => {
